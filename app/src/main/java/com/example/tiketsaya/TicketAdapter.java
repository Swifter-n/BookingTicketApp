...
public class TicketAdapter extends RecyclerView.Adapter<TicketAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.xjumlah_tiket.setText(myTicket.get(position).getJumlah_tiket().toString() + "Tickets");

        final String getNama_Wisata= myTicket.get(position).getNama_wisata();
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gotoMyTicket = new Intent(context, MyTicketAct.class);
